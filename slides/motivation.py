...
class Motivation(BaseSlide):
    TITLE = r'Motivation (TODO)'

    def create_content(self):
        s = self.slide

        bullets = BulletedList(
            r'\sffamily -- provide multi-shot ASP based approach for ABA disputes',
...
class MotivationScene(Slide):
    def construct(self):
        Motivation(self, show_footer=True, slide_no=SLIDE_NO, slide_total=SLIDES_NO)
        self.wait()
